...
<head>
    ...
    <link href="{{ asset('css/labtech/labTech.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="container mt-4">
        <div class="card mx-auto" style="max-width: 500px;">
            <div class="card-body">
                <h2 class="text-center">Laboratory Technician Registration</h2>
                ...
                <form action="{{ route('technician.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-2">
                        <input type="number" class="form-control @error('technician_id') is-invalid @enderror" id="technician_id" name="technician_id" placeholder="Laboratory Technician ID" value="{{ old('technician_id') }}" required>
                        <label for="instructor_id">Laboratory Technician ID</label>
                        @error('technician_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
